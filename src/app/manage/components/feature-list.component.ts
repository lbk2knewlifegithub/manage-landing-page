  ...
  template: `
    <div class="container lg:flex lg:gap-10 lg:justify-between">
      <div>
        ...
        <p
          class="text-skin-muted mt-5 text-center leading-7  lg:text-left lg:text-xl"
        >
          Manager provides all the functionally yru team need, without the
          complexity. Our software is tailor-made for modern digital products
          teams.
        </p>
      </div>

      <ul class="mt-6 space-y-10 lg:mt-0">
